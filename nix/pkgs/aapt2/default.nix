  ...
  urls = {
    jar = fetchurl {
      ...
      sha256 = getAttr platform {
        ...
        osx = "sha256-WGfM8bwAm8wBX+MJqwi5aWfa0T5KqokCp9N175hfp88=";
      };
    };
    sha = fetchurl {
      ...
      sha256 = getAttr platform {
        ...
        osx = "sha256-RHUJmauvDPLUOGjJyklEIlhl//su7iwddnmS2On9sNw=";
      };
    };
    pom = fetchurl {
      url = "${repoUrl}/${pkgPath}/${version}/${filenames.pom}";
      sha256 = "sha256-XYPIjO+++62EvDVaL0t8fLUnFapY5nWPc9E9JSjRlLI=";
    };
  };
