(ns status-im.ui.screens.communities.request-to-join-bottom-sheet-redesign
  (:require [status-im.i18n.i18n :as i18n]
            ...
            [quo2.components.context-tags :as quo2.context-tags]
            [quo2.foundations.colors :as quo2.colors]))

(def coinbase-token "../resources/images/tokens/mainnet/COB.png")
...
(defn rules-checkbox [checkbox-state]
  [react/view {:style
               {:flex 1
                :flex-direction :row
                :margin-top 20
...
(defn request-to-join []
  (let [checkbox-state (reagent/atom false)]
    ...
    [react/view {:style {:flex 1  :margin-left 20 :margin-right 20 :margin-bottom 20}}
     ...
     [quo2.context-tags/context-tag {:style {:margin-right :auto :margin-top 8}} coinbase-token "coinbase"]
     ...
     [react/view {:style {:width "100%"
      ...
      [quo2.button/button {:type :grey :style {:flex 1 :margin-right 12}}   (i18n/label :t/cancel)]
      [quo2.button/button {:flex 1}   (i18n/label :t/join-open-community)]]]))
